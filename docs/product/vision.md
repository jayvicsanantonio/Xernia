...
The app should help users answer: "What is happening with my body, what changed, what matters, and what should I do next?"
...
People who suspect sleep, food, stress, training, medication, hormones, travel, or routines are affecting how they feel and want to find patterns.

Needs:

- Timeline of symptoms and behaviors.
- Easy note capture.
...
People who track many signals and want to run personal experiments.
...
People using training, recovery, sleep, heart rate, HRV, nutrition, and injury data to improve performance.

Needs:

- Training load and recovery context.
- Sleep and readiness summaries.
- Injury and soreness tracking.
- Adaptive plans.

### Patients and Care Navigators

People managing conditions, medications, appointments, test results, and medical documents.
...
- Shareable summaries for clinicians.

## Positioning

Xernia is not a diagnosis app. It is not a doctor replacement. It is a personal health understanding tool.
...
1. Trust before cleverness.
   Health guidance must be explainable, sourced, and appropriately cautious.
